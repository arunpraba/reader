...
A private Markdown workspace for immersive reading and listening — your pages stay on this device.

> **Note:** This project is built for learning purposes only.

**Live app:** https://arunpraba.github.io/reader/

## What it does

Margin helps you build a personal library of Markdown pages and return to them with focus.
...
- `npm test`: production build + unit tests in `lib/`
